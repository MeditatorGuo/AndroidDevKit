package com.aliex.basekit.base.adapter.helper;

import android.content.Context;

import com.aliex.basekit.base.adapter.BaseViewHolder;
import com.aliex.basekit.base.adapter.BasicAdapter;

import java.util.ArrayList;
import java.util.List;

public abstract class HelperAdapter<T> extends BasicAdapter<T> implements DataHelper<T> {
    ...
    public void addAll(int startPosition, List<T> dataList) {
        if (mList != null)
            mList.addAll(startPosition, dataList);
