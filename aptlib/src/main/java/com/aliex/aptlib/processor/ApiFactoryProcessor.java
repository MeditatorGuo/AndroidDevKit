...
import com.aliex.aptlib.annotation.apt.ApiFactory;
                ...
                for (Element e : element.getEnclosedElements()) {
                    ...
                    if (TypeName.get(executableElement.getReturnType()).toString().contains(DATA_ARR_CLASS)) {// 返回列表数据
                        ...
                        methodBuilder.addStatement(
                                ...
                                ClassName.get("com.api", "Api"), e.getSimpleName().toString(),
                                blockBuilder.build().toString(), ClassName.get("com.base.util.helper", "RxSchedulers"));
