...
import com.aliex.commonlib.assist.ShellUtil;

import java.io.File;

/**
 * author: Aliex <br/>
 * created on: 2017/3/5 <br/>
 * description: <br/>
 */
...
public class SilentInstaller {
    ...
    public int uninstallSilent(Context context, String packageName, boolean isKeepData) {
        ...
        ShellUtil.CommandResult commandResult = ShellUtil.execCommand(command.toString(), !isSystemApplication(context),
                true);
    ...
    public int getInstallLocation() {
        ShellUtil.CommandResult commandResult = ShellUtil
                .execCommand("LD_LIBRARY_PATH=/vendor/lib:/system/lib pm get-install-location", false, true);
