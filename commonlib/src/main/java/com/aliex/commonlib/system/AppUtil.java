...
import com.aliex.commonlib.utils.DensityUtils;
...
public class AppUtil {
    ...
    /**
     * need < uses-permission android:name =“android.permission.GET_TASKS” /> 判断是否前台运行
     */
    ...
    public static String getUserAgent(Context context, String appId) {
        ...
        userAgent.append(SEMICOLON);
        userAgent.append(DensityUtils.getScreenW(context) + "*" + DensityUtils.getScreenH(context)); // 分辨率
        userAgent.append(SEMICOLON);
        ...
        if (context != null && !TextUtils.isEmpty(permission)) {
            try {
                ...
                if (packageManager != null) {
                    if (PackageManager.PERMISSION_GRANTED == packageManager.checkPermission(permission,
    ...
    public static void cleanDatabases(Context context) {
        String filepath = String
                .format(String.format(context.getFilesDir().getParent() + File.separator + "%s", "databases"));
        FileUtils.deleteFileByDirectory(new File(filepath));
    }

    public static void cleanSharedPreference(Context context) {
        String filepath = String
                .format(String.format(context.getFilesDir().getParent() + File.separator + "%s", "shared_prefs"));
        FileUtils.deleteFileByDirectory(new File(filepath));
    }
}
