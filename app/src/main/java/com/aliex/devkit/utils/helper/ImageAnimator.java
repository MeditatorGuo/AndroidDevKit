package com.aliex.devkit.utils.helper;
...
public class ImageAnimator {
    private String[] mImages = { "http://img-cdn.luoo.net/pics/essays/201701/Ftwd9K_sxJFVZyy2bCtEtWlyF5Le.jpg",
    ...
    ImageAnimator(CollapsingToolbarLayout collapsingToolbar, ImageView targetImage, ImageView outgoingImage) {
        ...
        Resources mResources = BaseApplication.getAppContext().getResources();
